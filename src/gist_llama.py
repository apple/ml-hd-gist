...
from .gist_caching import GistActivations, SlotValueGistActivations
...
class GistLlamaForCausalLM(LlamaPreTrainedModel, GistGenerationMixin):
    ...
    @torch.no_grad()
    def get_slot_value_gist_activations(
            self,
            input_ids: torch.LongTensor,
            attention_mask: torch.FloatTensor,
            attention_mask_gist: torch.FloatTensor,
            ...
            prompt_attention_masks_gist_value: Optional[torch.FloatTensor] = None,
        ...
        return SlotValueGistActivations.from_model_outputs(
            model_outputs=model_outputs,
            input_ids=input_ids,
